...
# TODO(Phase 2/RAG): This template is for the full RAG glossary injection.
# Currently, glossary blocks are generated by format_glossary_block() in
# hardcoded_glossary.py which produces XML-style markup.
