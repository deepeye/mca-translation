...
- [x] **Step 1: 替换 RISK_ANNOTATION_PROMPT 为中文版本**
...
- [x] **Step 1: 替换 SUGGESTION_PROMPT 为中文版本**
...
- [x] **Step 1: 在 RISK_BADGE_STYLES 常量后面添加 RISK_TYPE_LABELS**
...
- [x] **Step 1: 在 RISK_STYLES 常量后面添加 RISK_TYPE_LABELS**
...
- [x] **Step 4: 在浏览器中触发一次翻译任务，检查风险标注输出**
...
- [x] **Step 5: 如果一切正常，做最终 commit（如有遗漏修复）**
